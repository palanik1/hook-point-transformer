...
__attribute__ ((__always_inline__)) static inline int process_encaped_ipip_pckt (void **data, void **data_end, struct __sk_buff *xdp, bool *is_ipv6, __u8 *protocol, bool pass) {
    int action;
...
__attribute__ ((__always_inline__)) static inline int process_encaped_gue_pckt (void **data, void **data_end, struct __sk_buff *xdp, bool is_ipv6, bool pass) {
    int offset = 0;
    int action;
    if (is_ipv6) {
        __u8 v6 = 0;
...
__attribute__ ((__always_inline__)) static inline int process_packet (struct __sk_buff *xdp, __u64 off, bool is_ipv6) {
